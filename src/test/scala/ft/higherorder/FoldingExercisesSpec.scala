...
class FoldingExercisesSpec extends Specification {
  ...
  "FoldingExercises" should {

    "sumAListWithFoldLeft" in {
      foldLeft(0, List(1, 2, 3))(_ + _) === 6
    }
    ...
    "sumAListWithFoldRight" in {
      foldRight(0, List(1, 2, 3))(_ + _) === 6
    }

    "reconstructAListWithFoldRight" in {
      foldRight(List[Int](), List(1, 2, 3))((e, a) => e :: a) === List(1, 2, 3)
    }
